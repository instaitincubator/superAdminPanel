 ...
 * });
 */
export function useGetProfileInfoQuery(baseOptions: Apollo.QueryHookOptions<GetProfileInfoQuery, GetProfileInfoQueryVariables> & ({ variables: GetProfileInfoQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
